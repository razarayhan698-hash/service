...
# --- আপনার টেলিগ্রাম বটের সঠিক তথ্য ---
...
def home():
    ...
    <head>
        ...
        <style>
            ...
            /* Form Style */
            .form-title { color: #1a3a5a; font-size: 20px; text-align: center; margin-bottom: 20px; margin-top: 0; }
            .form-input { width: 100%; padding: 14px; margin-bottom: 15px; border: 1.5px solid #dbe3eb; border-radius: 12px; box-sizing: border-box; font-size: 15px; outline: none; }
            .submit-btn { background: #2b5d8c; color: white; padding: 16px; width: 100%; border: none; border-radius: 12px; font-weight: bold; font-size: 16px; cursor: pointer; }
    ...
    <body>
        ...
        <div class="container">
            <div class="card" onclick="showModal('contactModal')">
                ...
                <div><b>Contacts & Support</b><br><span style="color:#888; font-size:13px">Agent Application & Issues</span></div>
            </div>
        </div>
        ...
        <div id="contactModal" class="modal">
            <h3 class="form-title">Select Category</h3>
            ...
            <div style="background:#f1f5f9; padding:15px; border-radius:12px; margin-bottom:10px; cursor:pointer; font-weight:bold" onclick="openForm('Report App Problem')">🛠️ Report App Problem</div>
        ...
        <div id="formModal" class="modal">
            ...
            <div id="successState">
                ...
                <div style="color: #2c3e50; font-size: 18px; font-weight: bold; margin: 10px 0;">আবেদন সফল হয়েছে!</div>
                ...
                <button class="submit-btn" style="background:#f0f2f5; color:#333;" onclick="hideModals()">ঠিক আছে</button>
            </div>
        </div>
